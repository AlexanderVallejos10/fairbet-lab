...
class Event(models.Model):
    ...
    sport = models.CharField(max_length=20, choices=Sport.choices, default=Sport.FUTBOL)
    ...
    max_total_bets = models.PositiveIntegerField(default=1000)
    max_bets_per_user = models.PositiveIntegerField(default=3)
    max_event_exposure = models.DecimalField(max_digits=18, decimal_places=4, default=Decimal("10000.0000"))
...
class Odd(models.Model):
    ...
    max_selection_exposure = models.DecimalField(max_digits=18, decimal_places=4, default=Decimal("5000.0000"))
    updated_at = models.DateTimeField(auto_now=True)
    created_at = models.DateTimeField(auto_now_add=True)
