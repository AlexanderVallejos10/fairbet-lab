...
class OperatorDashboardView(APIView):
    ...
    def get(self, request):
        total_staked = Bet.objects.aggregate(total=Sum("stake")).get("total") or Decimal("0.0000")
        total_paid = Bet.objects.aggregate(total=Sum("payout")).get("total") or Decimal("0.0000")
